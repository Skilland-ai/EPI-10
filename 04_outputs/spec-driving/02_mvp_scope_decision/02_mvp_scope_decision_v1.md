...
### 1. Workshop de arranque operativo

Incluir un workshop inicial con Carmen, Aitor y el equipo operativo necesario para cerrar el flujo real de Fase 1:

- estados del servicio;
- responsables;
- puntos de entrada desde web/pago;
- datos mínimos a capturar;
- formularios, consentimientos y cuestionarios;
- documentos/analíticas;
- proceso de informe final;
- eventos que deben generar tareas o notificaciones.

Rationale: Stage 01 detecta que el flujo definitivo no está cerrado y que cerrar microdetalle en preventa sería arriesgado. [SRC-002]
...
- No se cierra presupuesto exacto de licencias ni infraestructura.
...
| --- | --- | --- |
| Healthie/ContinuousCare plan, API, coste, DPA, residencia e idioma | Determina viabilidad de portal, integración y tratamiento documental | Unknown; Healthie parece candidato principal pero no validado |
| Estado real de Odoo | Determina cuánto es configuración vs integración/desarrollo | Unknown; se sabe que existe o está previsto, pero no su estado completo |
...
| Datos sensibles/legal/DPO | Determina límites de almacenamiento, proveedor, permisos y comunicación | Requisito real, revisión especializada pendiente |
...
3. ¿Qué versión/modalidad/módulos/API tiene Odoo actualmente?
4. ¿Quién desarrolla la web y qué eventos puede emitir tras formulario/pago?
5. ¿Qué pasarela de pago se usará?
6. ¿Qué datos sensibles recoge la web y qué datos deben moverse al portal?
7. ¿Cuál es la plantilla actual del informe final y cuánto tarda su producción?
8. ¿Qué partes del informe pueden parametrizarse sin automatizar análisis genético?
9. ¿Cuántos clientes/mes espera EPI10 y cuántas horas manuales dedica Aitor/equipo?
10. ¿Qué revisión legal/DPO exige EPI10 antes de usar Healthie/Odoo/proveedores?
11. ¿Puede TellmeGen compartir el presupuesto/API antiguo y alcance de endpoints?
